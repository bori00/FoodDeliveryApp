...
public class CartController {
    ...
    public void addItemToCart(@Valid @RequestBody CartItemDTO cartItemDTO) throws AccessRestrictedToAdminsException, CartItemsFromMultipleRestaurantsException, FoodNotFoundException, RestaurantNotFoundException {
